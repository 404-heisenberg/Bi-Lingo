module.exports = async (req, res) => {
    ...
    try {
        ...
        const primaryPrompt = 'You are a bilingual math tutor. Return ONLY a JSON object with keys english, isizulu, sesotho. No extra text. Do not include reasoning. Keep digits and numerals exactly the same as in the English answer.';
